...
class DefinitionsControllerTest < ActionController::TestCase
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post :create, definition: { content: @definition.content, source: @definition.source, title: @definition.title }
    end
  ...
  test "should update definition" do
    patch :update, id: @definition, definition: { content: @definition.content, source: @definition.source, title: @definition.title }
    assert_redirected_to definition_path(assigns(:definition))
  end
